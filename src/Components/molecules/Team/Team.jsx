                ...
                <div className='content'>
                    ...
                    <div className='team_description'>
                        ...
                        <div className='text'>
                             ...
                             {(this.state.windowWidth<=895)? '':<Text className='team_description_text'value='Дизайн конференция уже шестой год подряд объединяет профессионалов в сфере  цифровых технологий и инноваций, которые делятся своими идеями, полезной информацией о новых продуктах и сервисах'></Text>} 
